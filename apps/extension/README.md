# VentureLabs browser extension

Capture any webpage into your VentureLabs pipeline in one click — the same flow as
...
4. Pin "VentureLabs" to the toolbar
...
- **API key**: create one in VentureLabs → Settings → API keys

## Use

Visit any page → click the VentureLabs icon → adjust the title / add a note →
**Capture to pipeline**.
